Rails.application.configure do
  ...
  # config.active_job.queue_name_prefix = "tracing_resilience_#{Rails.env}"

  config.action_mailer.perform_caching = false
  config.action_mailer.default_url_options = { host: 'http://tracing-resilience-staging.herokuapp.com/'}
